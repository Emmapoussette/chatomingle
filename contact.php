...
<html>
<head>
<title>Find Your Perfect Partner -MingleFoReal
 | Contact ::
</title>
...
<div class="grid_3">
  <div class="container">
   ...
   <div class="grid_5">
      <p>Any quesstions plase fill free to ask, either using social media accounts, call or text.</p>
      <address class="addr row">
        ...
        <dl class="grid_4">
            <dt>E-mail :</dt>
            <dd><a href="mingleforeal@gmail.com">mail(at)MingleFoReal</a></dd>
        </dl>
      </address>
    </div>
   </div>
