...
<div class="grid_1">
      <div class="container">
        ...
        <ul id="flexiselDemo3">
        <?php
        	$sql="SELECT Name FROM audience inner join events e.event inner join venue e.address Where payment_status='1' inner join customer ";
