...
<html>
<head>
<title>MingleFoReal | User :: LastStep
</title>
  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Fill each step clearly</li>
     </ul>
   </div>
   <div class="navigation" style="background-color: #ccc;"><!-- Innernavigation starts -->
   	  	...
   	  	<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
		        <ul class="nav navbar-nav nav_1">
		            <!--<li><a href="photouploader.php?id=<?php echo $id;?>">Upload Your Profile</a></li>-->
		            <li><a href="view_profile.php?id=<?php echo $id;?>">Step2 Create Your Profile</a></li>
		            <li><a href="partner_preference.php?id=<?php echo $id;?>">Step3 Your Photos</a></li>
		    		<li class="dropdown">
