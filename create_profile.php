			         ...
			         <div class="col-sm-4 form_box">
	                  <div class="select-block1">
	                    <select name="religion">
		                    ...
		                    <option value="Jain">Protestant</option>
		                    <option value="Sikh">Traditional</option>
	            ...
	            <div class="col-sm-4 form_box2">
	                   <div class="select-block1">
	                    <select name="caste">
		                    ...
		                    <option value="Advantinst">Advantinst</option>
		                    <option value="ADER">ADPER</option>
	                 ...
	                 <div class="col-sm-4 form_box1">
	                   <div class="select-block1">
	                    <select name="subcaste">
		                    ...
		                    <option value="Not deeply">Not deeply</option>
		      ...
		      <label for="edit-name">Diet<span class="form-required" title="This field is required.">*</span></label>
			    <div class="select-block1">
	                <select name="diet">
						...
						<option value="Both">All Diet</option> 
