  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
		...
		<!--<li> <a href="create_profile.php">Create Your Profile</li>-->
     </ul>
   </div>
   <div class="services">
	  ...
	  <div class="col-sm-6">
	     <ul class="sharing">
			...
			<li><a href="#" class="google" title="google"><i class="fa fa-boxed fa-fw fa-instagram"></i> Share on Instagram</a></li>
		  	<li><a href="www.linkedin.com/in/mingle-foreal-4ab69422a" class="linkedin" title="Linkedin"><i class="fa fa-boxed fa-fw fa-linkedin"></i> Share on LinkedIn</a></li>
		 </ul>
	  </div>
	  <div class="clearfix"> </div>
   </div>
