...
<html>
<head>
<title>MingleFoReal| View_profile ::  
</title>
			...
			<div class="col-sm-8 row_1">
				<table class="table_working_hours">
		        	<tbody>
						...
						<tr class="closed">
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="messenger/index.php" id="#">
					<i class=""></i> Start Chart
				</a></span>
						</tr>
				    </tbody>
				</table>
